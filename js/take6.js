...
function getCard(number, x, y) {
  ...
  if( 0 == (number % 5) && 0 == ( number % 11) ) {
    ...
    card.add(getLogo('red', 75, 100, 1.5, 0));

    card.add(getLogo('red',  45, 10, 0.15, 0));
    card.add(getLogo('red',  55, 25, 0.15, 0));
    card.add(getLogo('red',  65, 10, 0.15, 0));
    card.add(getLogo('red',  75, 25, 0.15, 0));
    card.add(getLogo('red',  85, 10, 0.15, 0));
    card.add(getLogo('red',  95, 25, 0.15, 0));
    card.add(getLogo('red', 105, 10, 0.15, 0));

    card.add(getLogo('red',  45, 210 - 10, 0.15, 180));
    card.add(getLogo('red',  55, 210 - 25, 0.15, 180));
    card.add(getLogo('red',  65, 210 - 10, 0.15, 180));
    card.add(getLogo('red',  75, 210 - 25, 0.15, 180));
    card.add(getLogo('red',  85, 210 - 10, 0.15, 180));
    card.add(getLogo('red',  95, 210 - 25, 0.15, 180));
    card.add(getLogo('red', 105, 210 - 10, 0.15, 180));
  } else {
    card.add(getLogo('purple', 75, 100, 1.5, 0));    
  }
  card.add(getText(number, 75, 105, 1.6, 0, '#EEEE00', '#222222'));

  card.add(getText(number,  17,  20, 0.5, 0, '#EEEE00', '#222222'));
  card.add(getText(number,  17, 190, 0.5, 180, '#EEEE00', '#222222'));
  card.add(getText(number, 133,  20, 0.5, 0, '#EEEE00', '#222222'));
  card.add(getText(number, 133, 190, 0.5, 180, '#EEEE00', '#222222'));

  return card;
}

function getLogo(color, x, y, scale, deg) {
...
function getText(number, x, y, scale, deg, fill, stroke) {
